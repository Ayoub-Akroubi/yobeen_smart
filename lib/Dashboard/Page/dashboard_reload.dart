...
class DashboardReload extends StatefulWidget {
  const DashboardReload({Key? key}) : super(key: key);

  @override
  State<DashboardReload> createState() => _DashboardReloadState();
}

class _DashboardReloadState extends State<DashboardReload> {
  dynamic serial = "";
